  ...
  try {
    ...
    try {
      ...
      const result = await model.generateContent([
        ...
        {
          text: `
            Based on the provided resume, generate a detailed referals for the candidate.
            Please include:
            ...
            Provide the response  format with the following structure:
        ...
        matchScore: '97',
        experience: '5',
      },give the data in json format only do not add any new identifiers in it
          `,
        },
      ]);
